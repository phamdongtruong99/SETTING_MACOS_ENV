# SETTING FOR MY MACOS

- Welecome come to my world, to config that. Let's start.
- Open terminal and type

```
cd ~  && git clone https://github.com/tranthaison1231/INIT_ENVIRONMENT && bash ./INIT_ENVIRONMENT/step1.sh 
```
...
- **GITHUB ACTION AWS S3**: https://medium.com/trackstack/deploying-a-react-app-to-aws-s3-with-github-actions-b1cb9ba75c95
- **VPS**:
